...
var config = module.exports = {
    ...
    resolve: {
        ...
        alias: {
            mcore: 'mcoreapp',
            mcoreapp: path.join(__dirname, './node_modules/mcoreapp/dist/mcoreApp'),
            mcoreApp: 'mcoreapp',
            mcoreExtBinderValidator: path.join(__dirname, './node_modules/mcoreapp/ext/binder/validator'),
            mcoreExtUiPopover: path.join(__dirname, './node_modules/mcoreapp/ext/ui/popover'),
            mcoreExtTagPagination: path.join(__dirname, './node_modules/mcoreapp/ext/tag/pagination'),
            mcoreExtPlusWatch: path.join(__dirname, './node_modules/mcoreapp/ext/plus/watch'),
            mcoreExtPlusErrorCatch: path.join(__dirname, './node_modules/mcoreapp/ext/plus/errorCatch'),
        }
    },
    externals: {
        jquery: 'jQuery'
